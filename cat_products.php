...
<!-- header -->
<?php
// Check if the category variable is set in the URL
if(isset($_GET['category'])) {
    $category = $_GET['category'];
    // Now you can use the $category variable as needed
    $db="grocery";
    $connect = mysqli_connect('localhost','root','',$db);
    $query = mysqli_query($connect,"SELECT * FROM products where catogery='$category'");
} else {
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        echo "<td>";
                        echo "<form action='add_to_cart.php' method='post' enctype='multipart/form-data'>";
                        echo "<input type='hidden' name='cpid' value='" . $row["ID"] . "'/>";
                        echo "<input type='hidden' name='ccost' value='" . $row["cost"] . "'/>";
